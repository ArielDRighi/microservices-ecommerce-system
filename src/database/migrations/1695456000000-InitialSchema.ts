...
export class InitialSchema1695456000000 implements MigrationInterface {
  name = 'InitialSchema1695456000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE INDEX "IDX_inventory_location" ON "inventory" ("location_id")');
    await queryRunner.query(
      'CREATE INDEX "IDX_inventory_low_stock" ON "inventory" ("available_quantity", "reorder_point")',
    );

    await queryRunner.query('CREATE INDEX "IDX_outbox_processed" ON "outbox_events" ("processed")');
    await queryRunner.query(
    ...
    await queryRunner.query('CREATE INDEX "IDX_saga_status" ON "saga_state" ("status")');
    await queryRunner.query('CREATE INDEX "IDX_saga_type" ON "saga_state" ("saga_type")');
    await queryRunner.query('CREATE INDEX "IDX_saga_aggregate" ON "saga_state" ("aggregate_id")');
    await queryRunner.query('CREATE INDEX "IDX_saga_expires_at" ON "saga_state" ("expires_at")');
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    // Drop tables in reverse order to handle foreign key constraints
    await queryRunner.query('DROP TABLE "saga_state"');
